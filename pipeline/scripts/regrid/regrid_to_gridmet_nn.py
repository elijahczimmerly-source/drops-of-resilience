...
Output directory: ``DOR_NN_DATA_DIR``, or ``DOR_REGRID_OUTPUT_DIR``, or default
``pipeline/data/regrid_nearest_neighbor``. Input paths: see ``README.md`` (same env vars as bilinear).
...
from regrid_paths import output_dir_nn, paths_for_regrid

# ==========================================
# CONFIGURATION
# ==========================================
OUTPUT_DIR = output_dir_nn()
...
if __name__ == "__main__":
    print(f"[regrid nn] OUTPUT_DIR={OUTPUT_DIR}")
    print(f"[regrid nn] CMIP6={PATHS['CMIP6']}")
    print(f"[regrid nn] GridMET={PATHS['GridMET']}")
