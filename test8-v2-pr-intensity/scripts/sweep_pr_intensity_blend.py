...
_MAIN = _SCRIPTS_DIR / "test8_v2_pr_intensity.py"
_OUT_ROOT = _SCRIPTS_DIR.parent / "output" / "test8_v2_pr_intensity"
...
def main() -> int:
    ...
    with open(_RESULTS, "a", newline="", encoding="utf-8") as fp:
        ...
        for b in blends:
            ...
            rc = subprocess.call([py, "-u", str(_MAIN)], cwd=str(_SCRIPTS_DIR), env=env)
